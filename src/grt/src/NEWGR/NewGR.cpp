                            ...
                            utl::Logger* logger)
{
  ...
  if (grouter != nullptr && grouter->grid() != nullptr) {
    ...
    // conservative about merging. Allowing a very small merge gap tends to
    // reduce fragmentation without meaningfully increasing layer switching.
    nonpreferred_merge_gap_dbu = tile;
