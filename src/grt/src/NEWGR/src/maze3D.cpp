                                       ...
                                       int edge_n1A2)
{
  ...
  if (cnt_n1A1 == 1) {
    logger_->error(
        GNR, 187, "In 3D maze routing, type 1 node shift, cnt_n1A1 is 1.");
  }
  ...
  if (E1_pos1 == -1) {
    logger_->error(GNR, 171, "Invalid index for position ({}, {}).", E1x, E1y);
  }
                                       ...
                                       int edge_C1C2)
{
  ...
  if (cnt_C1C2 == 1) {
    debugPrint(
        logger_, utl::GNR, "maze_3d", 1, "Shift to 0 length edge, type2.");
  }
  ...
  if (E1_pos2 == -1) {
    logger_->error(GNR, 172, "Invalid index for position ({}, {}).", E1x, E1y);
  }
