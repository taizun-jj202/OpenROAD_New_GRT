...
#define M2_ADJ_MIN 0.60
#define M2_ADJ_MAX 0.96
#define M2_ADJ_MID 3.5
#define M2_ADJ_K 2.0

#define M3_ADJ_MIN 0.60
#define M3_ADJ_MAX 0.96
#define M3_ADJ_MID 3.5
#define M3_ADJ_K 2.0

#define MID_ADJ_MIN 0.95
#define MID_ADJ_MAX 0.95
#define MID_ADJ_MID 5.0
#define MID_ADJ_K 2.0

#define HIGH_ADJ 0.85
