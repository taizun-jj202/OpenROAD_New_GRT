...
#define M2_ADJ_MIN 0.57
#define M2_ADJ_MAX 0.94
#define M2_ADJ_MID 3.5
#define M2_ADJ_K 2.0

#define M3_ADJ_MIN 0.57
#define M3_ADJ_MAX 0.94
#define M3_ADJ_MID 3.5
#define M3_ADJ_K 2.0

#define MID_ADJ_MIN 0.93
#define MID_ADJ_MAX 0.93
#define MID_ADJ_MID 5.0
#define MID_ADJ_K 2.0

#define HIGH_ADJ 0.80

#define OBS_NO_STOP 0 // 1 == go through OBS, 0 == hard stop

#define DEFAULT_RUDY_WEIGHT 0.13
#define NO_RUDY 0
