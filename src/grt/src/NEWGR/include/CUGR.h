...
struct Constants
{
  ...
  int refinement_hpwl_threshold = 56;
  double refinement_stretch_threshold = 1.05;
  int refinement_max_selected_nets = 2000;
  double detour_refine_ratio = 0.60;
  double maze_refine_ratio = 0.40;
  ...
  double recovery_wl_maze_via_cost_scale = 0.10;
  int recovery_wl_only_hpwl_threshold = 48;
  int recovery_hpwl_threshold = 20;
  double recovery_min_stretch = 1.00;
  int recovery_candidate_cap = 1250;
  int recovery_deep_search_cap = 540;
  int recovery_shallow_maze_config_limit = 5;
  int recovery_deep_maze_config_limit = 14;
  int recovery_shallow_wl_config_limit = 6;
  int recovery_deep_wl_config_limit = 14;
  double recovery_refine_ratio = 0.97;
  int recovery_max_passes = 6;
  double recovery_pass_decay = 0.88;
  int recovery_maze_sparse_x = 3;
  int recovery_maze_sparse_y = 3;
  double recovery_deep_ratio = 0.80;
  int recovery_deep_hpwl_threshold = 56;
  ...
  int recovery_max_via_increase = 14;
  bool recovery_use_full_grid_maze = true;
  int recovery_full_grid_top_n = 220;
  int recovery_full_grid_hpwl_threshold = 48;
