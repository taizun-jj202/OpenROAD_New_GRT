...
struct Constants
{
  ...
  int stage3_max_maze_configs = 12;
  bool stage3_use_wirelength_maze = true;
  int stage3_wl_only_hpwl_threshold = 120;
  int stage3_wl_config_limit = 6;
  double stage3_wl_via_cost_scale = 0.24;
  ...
  double recovery_wl_maze_via_cost_scale = 0.20;
  int recovery_wl_only_hpwl_threshold = 96;
  int recovery_hpwl_threshold = 88;
  double recovery_min_stretch = 1.02;
  int recovery_candidate_cap = 180;
  int recovery_deep_search_cap = 80;
  int recovery_shallow_maze_config_limit = 4;
  int recovery_deep_maze_config_limit = 8;
  int recovery_shallow_wl_config_limit = 3;
  int recovery_deep_wl_config_limit = 6;
  double recovery_refine_ratio = 0.85;
  int recovery_max_passes = 3;
  double recovery_pass_decay = 0.80;
  double recovery_late_pass_refine_scale = 0.55;
  double recovery_late_pass_cap_scale = 0.45;
  double recovery_late_pass_deep_ratio_scale = 0.70;
  int recovery_late_pass_abs_cap = 56;
  int recovery_late_pass_min_first_pass_accepts = 2;
  int recovery_maze_sparse_x = 3;
  int recovery_maze_sparse_y = 3;
  double recovery_deep_ratio = 0.75;
  int recovery_deep_hpwl_threshold = 120;
  ...
  int recovery_max_maze_configs = 12;
  ...
  int recovery_full_grid_hpwl_threshold = 140;
  double recovery_full_grid_via_cost_scale = 0.015;
