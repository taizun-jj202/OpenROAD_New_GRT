...
struct Constants
{
  ...
  int refinement_max_selected_nets = 1800;
  double detour_refine_ratio = 0.55;
  ...
  int stage3_max_maze_configs = 18;
  ...
  int recovery_deep_wl_config_limit = 10;
  ...
  int recovery_full_grid_top_n = 80;
